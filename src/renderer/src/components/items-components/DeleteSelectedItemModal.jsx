...
const DeleteSelectedItemModal = ({ deleteSelectedItems, onClose }) => {
  const dispach = useDispatch()

  const handleSubmit = (e) => {
    e.preventDefault()
    deleteSelectedItems.forEach((itemId) => {
      dispach(deleteItem(itemId))
    })
      ...
      >
        ...
        <div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">Do You Want To Delete These Item?</div>
...
export default DeleteSelectedItemModal
